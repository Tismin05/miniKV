...
type GetResponse struct {
	...
	Value         string                 `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty"`
	Timestamp     int64                  `protobuf:"varint,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"` // 新增：数据的写入时间戳，Quorum 读比较用
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_api_proto_kv_proto_rawDesc = "" +
	...
	"\x06Delete\x12\x11.kv.DeleteRequest\x1a\x12.kv.DeleteResponseB\x1cZ\x1amy-kv-store/api/proto/kvpbb\x06proto3"
